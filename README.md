# Hi, I'm Risyadhana Syaifuddin 👋

### 🚀 Data Science Practitioner & Full-Stack Developer
I bridge the gap between complex data insights and seamless user experiences. Specialist in **Hybrid Deep Learning** and **Scalable Mobile-Backend Architectures**.

---

### 🛠️ Technical Stack
- **AI & Data Science:** Python (TensorFlow, Keras, Scikit-Learn, XGBoost, Time-Series Forecasting).
- **Data Engineering:** SQL, PostgreSQL, NoSQL (Elasticsearch), Apache Airflow (ETL Automation).
- **Full-Stack Development:** Flutter (GetX), Node.js (Express.js), Sequelize ORM.
- **Tools & Deployment:** Power BI, Streamlit, Docker, HuggingFace, Git.
...
<p align="left">
  <img src="https://github-readme-stats.vercel.app/api?username=Dhansstar&show_icons=true&theme=tokyonight&hide_border=true" alt="Dhansstar Stats" />
